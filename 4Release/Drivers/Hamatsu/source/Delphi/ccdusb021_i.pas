...
function CCDUSB_MemoryWrite ( ID, aStartAddr : Integer; aBuff : PWORDArr; BuffSize : Integer  ) : boolean; stdcall; external 'CCDUSBDCOM01.dll'
function CCDUSB_MemoryRead  ( ID, aStartAddr : Integer; aBuff : PWORDArr; BuffSize : Integer  ) : boolean; stdcall; external 'CCDUSBDCOM01.dll'
function CCDUSB_MemoryFileWrite ( ID : Integer; FileName : PAnsiChar ) : boolean; stdcall; external 'CCDUSBDCOM01.dll'
function CCDUSB_MemoryFileRead  ( ID : Integer; FileName : PAnsiChar ) : boolean; stdcall; external 'CCDUSBDCOM01.dll'
